...
/**
 * This Ztools_NotEqualByType component is addition to default Zend_Validate validators.
 * Assert that values are not equal by type and value.
 * 
 ...
 */
class Ztools_Assert_NotEqualByType extends Zend_Validate_Abstract
{
    /**
     * Validation failure message key
     */
    const ASSERT_FAILED_MSG            = 'notEqualByType';
    ...
    protected $_messageTemplates = array(
        self::ASSERT_FAILED_MSG        => "'%value%' is equal by type and value with '%assertValue%'",
    );
