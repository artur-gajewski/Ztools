...
/**
 * This Ztools_Between component is addition to default Zend_Validate validators.
 * Assert that data is between a given value.
 * 
 ...
 */
class Ztools_Assert_Between extends Zend_Validate_Abstract
{
    /**
     * Validation failure message key
     */
    const ASSERT_FAILED_MSG            = 'between';
    ...
    protected $_messageTemplates = array(
        self::ASSERT_FAILED_MSG        => "'%value%' is not between '%assertValueMin%\ and '%assertValueMax%'",
    );
