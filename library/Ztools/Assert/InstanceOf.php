...
/**
 * This Ztools_InstanceOf component is addition to default Zend_Validate validators.
 * Assert that data is an instance of given object.
 * 
 ...
 */
class Ztools_Assert_InstanceOf extends Zend_Validate_Abstract
{
    /**
     * Validation failure message key
     */
    const ASSERT_FAILED_MSG            = 'instanceOf';
    ...
    protected $_messageTemplates = array(
        self::ASSERT_FAILED_MSG        => "Value is not an instance of '%assertValue%'",
    );
