...
/**
 * This Ztools_Object component is addition to default Zend_Validate validators.
 ...
 */
class Ztools_Assert_Object extends Zend_Validate_Abstract
{
    /**
     * Validation failure message key
     */
    const ASSERT_FAILED_MSG            = 'object';
    ...
    protected $_messageTemplates = array(
        self::ASSERT_FAILED_MSG        => "Value is not an object",
    );
