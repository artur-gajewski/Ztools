...
/**
 * This Ztools_Array component is addition to default Zend_Validate validators.
 ...
 */
class Ztools_Assert_Array extends Zend_Validate_Abstract
{
    /**
     * Validation failure message key
     */
    const ASSERT_FAILED_MSG            = 'array';
    ...
    protected $_messageTemplates = array(
        self::ASSERT_FAILED_MSG        => "Given value is not an array",
    );
