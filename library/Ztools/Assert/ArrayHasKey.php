...
/**
 * This Ztools_ArrayHasKey component is addition to default Zend_Validate validators.
 * Assert that data has a given key.
 * 
 ...
 */
class Ztools_Assert_ArrayHasKey extends Zend_Validate_Abstract
{
    /**
     * Validation failure message key
     */
    const ASSERT_FAILED_MSG            = 'arrayHasKey';
    ...
    protected $_messageTemplates = array(
        self::ASSERT_FAILED_MSG        => "Array key '%value%' was not found",
    );
