...
/**
 * This Ztools_Integer component is addition to default Zend_Validate validators.
 * Assert that data is integer.
 * 
 ...
 */
class Ztools_Assert_Integer extends Zend_Validate_Abstract
{
    /**
     * Validation failure message key
     */
    const ASSERT_FAILED_MSG            = 'integer';
    ...
    protected $_messageTemplates = array(
        self::ASSERT_FAILED_MSG        => "Value is not integer",
    );
