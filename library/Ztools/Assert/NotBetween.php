...
/**
 * This Ztools_NotBetween component is addition to default Zend_Validate validators.
 * Assert that data is not between a given value.
 * 
 ...
 */
class Ztools_Assert_NotBetween extends Zend_Validate_Abstract
{
    /**
     * Validation failure message key
     */
    const ASSERT_FAILED_MSG            = 'notBetween';
    ...
    protected $_messageTemplates = array(
        self::ASSERT_FAILED_MSG        => "'%value%' is between '%assertValueMin%\ and '%assertValueMax%'",
    );
