...
/**
 * This Ztools_Outside component is addition to default Zend_Validate validators.
 * Assert that data is outside a given value.
 * 
 ...
 */
class Ztools_Assert_Outside extends Zend_Validate_Abstract
{
    /**
     * Validation failure message key
     */
    const ASSERT_FAILED_MSG            = 'outside';
    ...
    protected $_messageTemplates = array(
        self::ASSERT_FAILED_MSG        => "'%value%' is not outside values '%assertValueMin%\ and '%assertValueMax%'",
    );
