...
/**
 * This Ztools_GreaterThan component is addition to default Zend_Validate validators.
 * Assert that data is greater than a given value.
 * 
 ...
 */
class Ztools_Assert_Greater extends Zend_Validate_Abstract
{
    /**
     * Validation failure message key
     */
    const ASSERT_FAILED_MSG            = 'greaterThan';
    ...
    protected $_messageTemplates = array(
        self::ASSERT_FAILED_MSG        => "'%value%' is not greater than '%assertValue%'",
    );
