...
/**
 * This Ztools_NotInteger component is addition to default Zend_Validate validators.
 * Assert that data is not an integer.
 * 
 ...
 */
class Ztools_Assert_NotInteger extends Zend_Validate_Abstract
{
    /**
     * Validation failure message key
     */
    const ASSERT_FAILED_MSG            = 'notInteger';
    ...
    protected $_messageTemplates = array(
        self::ASSERT_FAILED_MSG        => "Value is integer",
    );
