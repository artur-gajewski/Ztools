...
/**
 * This Ztools_NotBoolean component is addition to default Zend_Validate validators.
 * Assert that data is not boolean.
 * 
 ...
 */
class Ztools_Assert_NotBoolean extends Zend_Validate_Abstract
{
    /**
     * Validation failure message key
     */
    const ASSERT_FAILED_MSG            = 'notBoolean';
    ...
    protected $_messageTemplates = array(
        self::ASSERT_FAILED_MSG        => "Value is a boolean",
    );
