...
/**
 * This Ztools_Equal component is addition to default Zend_Validate validators.
 * Assert that values are equal by value.
 * 
 ...
 */
class Ztools_Assert_Equal extends Zend_Validate_Abstract
{
    /**
     * Validation failure message key
     */
    const ASSERT_FAILED_MSG            = 'equal';
    ...
    protected $_messageTemplates = array(
        self::ASSERT_FAILED_MSG        => "'%value%' is not equal by value with '%assertValue%'",
    );
