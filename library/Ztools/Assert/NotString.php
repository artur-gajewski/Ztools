...
/**
 * This Ztools_NotString component is addition to default Zend_Validate validators.
 * Assert that data is not a string.
 * 
 ...
 */
class Ztools_Assert_NotString extends Zend_Validate_Abstract
{
    /**
     * Validation failure message key
     */
    const ASSERT_FAILED_MSG            = 'notString';
    ...
    protected $_messageTemplates = array(
        self::ASSERT_FAILED_MSG        => "Value is string",
    );
