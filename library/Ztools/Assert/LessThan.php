...
/**
 * This Ztools_LessThan component is addition to default Zend_Validate validators.
 * Assert that data is less than a given value.
 * 
 ...
 */
class Ztools_Assert_LessThan extends Zend_Validate_Abstract
{
    /**
     * Validation failure message key
     */
    const ASSERT_FAILED_MSG            = 'lessThan';
    ...
    protected $_messageTemplates = array(
        self::ASSERT_FAILED_MSG        => "'%value%' is not less than '%assertValue%'",
    );
