...
/**
 * This Ztools_Float component is addition to default Zend_Validate validators.
 * Assert that data is float.
 * 
 ...
 */
class Ztools_Assert_Float extends Zend_Validate_Abstract
{
    /**
     * Validation failure message key
     */
    const ASSERT_FAILED_MSG            = 'float';
    ...
    protected $_messageTemplates = array(
        self::ASSERT_FAILED_MSG        => "Value is not float",
    );
