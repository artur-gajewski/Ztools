...
/**
 * This Ztools_NotNumeric component is addition to default Zend_Validate validators.
 * Assert that data is not numeric string or a number.
 * 
 ...
 */
class Ztools_Assert_NotNumeric extends Zend_Validate_Abstract
{
    /**
     * Validation failure message key
     */
    const ASSERT_FAILED_MSG            = 'notNumeric';
    ...
    protected $_messageTemplates = array(
        self::ASSERT_FAILED_MSG        => "Value is numeric",
    );
