...
/**
 * This Ztools_NotObject component is addition to default Zend_Validate validators.
 * Assert that data is not an object.
 * 
 ...
 */
class Ztools_Assert_NotObject extends Zend_Validate_Abstract
{
    /**
     * Validation failure message key
     */
    const ASSERT_FAILED_MSG            = 'notObject';
    ...
    protected $_messageTemplates = array(
        self::ASSERT_FAILED_MSG        => "Value is an object",
    );
