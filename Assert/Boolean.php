...
/**
 * This Ztools_Boolean component is addition to default Zend_Validate validators.
 * Assert that data is boolean.
 * 
 ...
 */
class Ztools_Assert_Boolean extends Zend_Validate_Abstract
{
    /**
     * Validation failure message key
     */
    const ASSERT_FAILED_MSG            = 'boolean';
    ...
    protected $_messageTemplates = array(
        self::ASSERT_FAILED_MSG        => "Value is not a boolean",
    );
