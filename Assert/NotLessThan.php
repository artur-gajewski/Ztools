...
/**
 * This Ztools_NotLessThan component is addition to default Zend_Validate validators.
 * Assert that data is not less than a given value.
 * 
 ...
 */
class Ztools_Assert_NotLessThan extends Zend_Validate_Abstract
{
    /**
     * Validation failure message key
     */
    const ASSERT_FAILED_MSG            = 'notLessThan';
    ...
    protected $_messageTemplates = array(
        self::ASSERT_FAILED_MSG        => "'%value%' is less than '%assertValue%'",
    );
