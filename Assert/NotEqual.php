...
/**
 * This Ztools_NotEqual component is addition to default Zend_Validate validators.
 * Assert that values are not equal by value.
 * 
 ...
 */
class Ztools_Assert_NotEqual extends Zend_Validate_Abstract
{
    /**
     * Validation failure message key
     */
    const ASSERT_FAILED_MSG            = 'notEqual';
    ...
    protected $_messageTemplates = array(
        self::ASSERT_FAILED_MSG        => "'%value%' is equal by value with '%assertValue%'",
    );
