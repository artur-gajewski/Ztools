...
/**
 * This Ztools_Null component is addition to default Zend_Validate validators.
 ...
 */
class Ztools_Assert_Null extends Zend_Validate_Abstract
{
    /**
     * Validation failure message key
     */
    const ASSERT_FAILED_MSG            = 'null';
    ...
    protected $_messageTemplates = array(
        self::ASSERT_FAILED_MSG        => "Value is not null",
    );
