...
/**
 * This Ztools_NotNull component is addition to default Zend_Validate validators.
 ...
 */
class Ztools_Assert_NotNull extends Zend_Validate_Abstract
{
    /**
     * Validation failure message key
     */
    const ASSERT_FAILED_MSG            = 'notNull';
    ...
    protected $_messageTemplates = array(
        self::ASSERT_FAILED_MSG        => "Value is null",
    );
