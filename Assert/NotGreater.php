...
/**
 * This Ztools_NotGreaterThan component is addition to default Zend_Validate validators.
 * Assert that data is not greater than a given value.
 * 
 ...
 */
class Ztools_Assert_NotGreater extends Zend_Validate_Abstract
{
    /**
     * Validation failure message key
     */
    const ASSERT_FAILED_MSG            = 'notGreaterThan';
    ...
    protected $_messageTemplates = array(
        self::ASSERT_FAILED_MSG        => "'%value%' is greater than '%assertValue%'",
    );
