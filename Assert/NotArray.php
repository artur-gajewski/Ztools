...
/**
 * This Ztools_NotArray component is addition to default Zend_Validate validators.
 * Assert that data is not an array.
 * 
 ...
 */
class Ztools_Assert_NotArray extends Zend_Validate_Abstract
{
    /**
     * Validation failure message key
     */
    const ASSERT_FAILED_MSG            = 'notArray';
    ...
    protected $_messageTemplates = array(
        self::ASSERT_FAILED_MSG        => "Given value is an array",
    );
