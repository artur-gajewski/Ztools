...
/**
 * This Ztools_NotInstanceOf component is addition to default Zend_Validate validators.
 * Assert that data is not an instance of given object.
 * 
 ...
 */
class Ztools_Assert_NotInstanceOf extends Zend_Validate_Abstract
{
    /**
     * Validation failure message key
     */
    const ASSERT_FAILED_MSG            = 'notInstanceOf';
    ...
    protected $_messageTemplates = array(
        self::ASSERT_FAILED_MSG        => "Value is an instance of '%assertValue%'",
    );
    ...
    public function isValid($value)
    {
        ...
        if ($value instanceof $this->_assertValue) {
