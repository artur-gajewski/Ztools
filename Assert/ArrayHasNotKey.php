...
/**
 * This Ztools_ArrayHasNotKey component is addition to default Zend_Validate validators.
 * Assert that data has not a given key.
 * 
 ...
 */
class Ztools_Assert_ArrayHasNotKey extends Zend_Validate_Abstract
{
    /**
     * Validation failure message key
     */
    const ASSERT_FAILED_MSG            = 'arrayHasNotKey';
    ...
    protected $_messageTemplates = array(
        self::ASSERT_FAILED_MSG        => "Array key '%value%' was found",
    );
    ...
    public function isValid($value)
    {
        ...
        if (is_array($value) || array_key_exists($this->getAssertValue(), $value)) {
